  ...
  return (
    ...
    >
      ...
      <div className="relative h-full w-full overflow-hidden rounded-[30px] bg-gradient-to-br from-white/5 to-transparent p-6 md:p-8 backdrop-blur-3xl">
        ...
        <div
          className={`absolute -right-20 -top-20 h-64 w-64 rounded-full bg-gradient-to-br ${theme.bg} blur-[80px] opacity-50 transition-opacity group-hover:opacity-80`}
        />
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <div
                className={`h-2 w-2 rounded-full animate-pulse bg-current ${theme.text}`}
              />
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-[280px] text-sm leading-relaxed text-gray-500">
                {description ||
                  "High-performance digital ecosystem built for scale and precision."}
              </p>
            </div>
